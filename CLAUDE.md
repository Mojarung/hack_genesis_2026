...
236 спеков зелёные (покрытие строк 96.0%, ветви 79.9%), rubocop чист, чистая копия в Docker `ruby:4.0` проходит всё (с YJIT ≈3 300 заявок/с), `rake stress` — 17 сценариев и ~16 000 заявок
