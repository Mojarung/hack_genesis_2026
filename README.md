...
- `bundle exec rspec` — 195 примеров, покрытие строк 97.8%; интеграционные тесты гоняют скрипт организаторов, сверяют формат обоих файлов с образцом ТЗ поле за полем и пул допустимых с эталоном,
