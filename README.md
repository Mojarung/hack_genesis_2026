...
- `bundle exec rspec` — 236 примеров, покрытие строк 96.0% (ветви 79.9%); интеграционные тесты гоняют скрипт организаторов, сверяют формат обоих файлов с образцом ТЗ поле за полем и пул допустимых с эталоном,
