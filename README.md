...
- `bundle exec rspec` — 242 примера, покрытие строк 96.1% (ветви 80.2%); интеграционные тесты гоняют скрипт организаторов, сверяют формат обоих файлов с образцом ТЗ поле за полем и пул допустимых с эталоном,
